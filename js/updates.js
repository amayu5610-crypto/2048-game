export const updateHistory = [
  {
    version: "1.6.5",
    changes: [
      "Maze,Blind,Splitが正常に動作しない風具合を修正",
      "アチーブメントを複数端末で同期",
      "タイムアタック・サバイバルにゲーム開始前オーバーレイを追加",
      "他のユーザーと比較した際のUIを分かりやすく改善",
      "スマホ版にてMy Scoreの表示が崩れるのを修正",
      "スマホ版でゲーム画面が中央に表示されるように調整し上部に表示される情報を小さくしました",
    ]
  },
  {
    version: "1.6.4",
